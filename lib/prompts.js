...
- "marquage" = true UNIQUEMENT pour les CÔNES (produits dont la désignation commence par
  "Cône") si la description contient "Flocage", "Sérigraphié", "Sérigraphie", "MARQ",
  "Impression", "personnalisé" ou tout indicateur de personnalisation visuelle.
  Pour tous les autres produits (balises, poteaux, chaînes, panneaux, etc.) : toujours
  false, même si les mots "Impression" ou "personnalisé" apparaissent dans la description.
...
FORMAT DE SORTIE — Commence par une section RAISONNEMENT, puis le JSON :

RAISONNEMENT:
[Explique en 3 à 6 phrases : comment tu as identifié le destinataire et son adresse, comment tu as traité chaque référence (ambiguïtés, références manquantes ou illisibles), quelles lignes ont le marquage à true et pourquoi, et tout champ absent ou incertain.]
